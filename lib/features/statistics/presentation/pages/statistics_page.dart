    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: statisticsAsync.when(
              ...
              child: Column(
                ...
                children: [
                  ...
                  insightsAsync.when(
                    ...
                    error: (error, stack) => _buildErrorCard('İçgörüler yüklenirken hata oluştu'),
                  ),
          ...
          loading: () => const Center(child: CircularProgressIndicator()),
          error: (error, stack) => _buildErrorState('İstatistikler yüklenirken hata oluştu: $error'),
        ),
      ),
    );
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  album['artist'] ?? 'Bilinmeyen Sanatçı',
                  style: const TextStyle(
                    fontSize: 12,
                    color: AppTheme.textSecondary,
                  ),
