...
class _ImportSpotifyPlaylistsPageState extends State<ImportSpotifyPlaylistsPage> {
  ...
  Future<void> _loadSpotifyPlaylists() async {
    ...
    try {
      if (!EnhancedSpotifyService.isConnected) {
        throw Exception('Spotify bağlantısı gerekli. Lütfen önce giriş yapın.');
      }
  ...
  Future<void> _importSelected() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('${imported.length} playlist import edildi')),
    );
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Spotify hesabınızda playlist oluşturun',
            style: TextStyle(
